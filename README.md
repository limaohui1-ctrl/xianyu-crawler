...
1. **安装 Docker Desktop** — [下载](https://www.docker.com/products/docker-desktop/)
2. **启动本地 SearXNG** — 详见 `docs/SEARXNG_SETUP.md`
3. **配置 ACS** — 复制 `.env.example` 为 `.env`
4. **启动 ACS** — 双击 `启动ACS资料采集助手.bat`
...
> 📖 **首次使用？先看** `docs/USER_QUICK_START.md`  
> 🔧 **遇到问题？** `docs/TROUBLESHOOTING.md`  
> 🔍 **部署 SearXNG？** `docs/SEARXNG_SETUP.md`
